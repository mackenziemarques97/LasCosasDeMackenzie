...
filename = 'MackenzieStationaryPart2.lvm'; %'leap.lvm'
...
subplot(1,2,1), plot(time(1:end),OmegaX*180/pi,'linewidth', 2)
hold on
subplot(1,2,1), plot(time(1:end),OmegaY*180/pi, '-r','linewidth', 2)
subplot(1,2,1), plot(time(1:end),OmegaZ*180/pi, '-g','linewidth', 2)
grid
xlabel('time [sec]'), ylabel('Angular velocity [deg/s]')
title(filename)

% plot angular displacement data:
subplot(1,2,2), plot(time(1:end),thetaX*180/pi,'linewidth', 2)
hold on
subplot(1,2,2), plot(time(1:end),thetaY*180/pi, '-r','linewidth', 2)
subplot(1,2,2), plot(time(1:end),thetaZ*180/pi, '-g','linewidth', 2)
grid
